...
function handleMessage(msg) {
  ...
  if (msg.content.indexOf(botConfig.prefix + timeCommand.triggers[0]) == 0) {
    ...
    msg.content.indexOf(botConfig.prefix + "raid") == 0 ||
    msg.content.indexOf(botConfig.prefix + "join") == 0 ||
    msg.content.indexOf(botConfig.prefix + "leave") == 0
  ) {
    //raidCommand.run(msg);
  }
}
        ...
        .then(function (member) {
          if (member.id == bot.user.id) {
            ...
            try {
              ...
              console.log(
                "Failed to load data for " + guild.name + ": " + error
              );
            }
